...
class DatasetGenerator_1M():
    def __init__(seed,batchSize,eval_batch_size,dataPath,numOfWorkers):
        self.seed = seed
        np.random.seed(seed)
        self.batchSize = batchSize
        self.eval_batch_size = eval_batch_size
    ...
    def loadData(self):
        ...
        data_loaders['train_dataset'] = train_loader

        data_loaders['test_dataset'] = test_loader
